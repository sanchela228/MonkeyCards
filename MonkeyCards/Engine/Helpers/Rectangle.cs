...
{
    public Vector2 CenterShift(Vector2 centerPos, Vector2 size)
    {
        return new Vector2(centerPos.X - size.X / 2, centerPos.Y - size.Y / 2);
    }
    
    public Raylib_cs.Rectangle CenterShiftRec(Vector2 centerPos, Vector2 size)
    {
    ...
    public Raylib_cs.Rectangle CenterShiftRec(Raylib_cs.Rectangle rect)
    {
        return new Raylib_cs.Rectangle(
